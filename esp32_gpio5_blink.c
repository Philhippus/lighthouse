...
/* GPIO_FUNCn_OUT_SEL_CFG_REG: base 0x3FF44530, 4-byte stride per GPIO n (n=0..39) */
#define GPIO_FUNC_OUT_SEL_CFG_BASE 0x3FF44530u
#define GPIO_FUNCn_OUT_SEL_CFG_REG(n) (GPIO_FUNC_OUT_SEL_CFG_BASE + 4u * (n))
...
static void led_gpio_init(void)
{
    ...
    REG32(GPIO_FUNCn_OUT_SEL_CFG_REG(LED_GPIO_NUM)) = GPIO_FUNC_OUT_SEL_SIMPLE_GPIO;
